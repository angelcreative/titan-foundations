...
type NavbarTheme = 'demand' | 'audiense' | 'neutral' | 'insights' | 'linkedin' | 'tweetbinder' | 'connect';
type NavbarStatus = 'default' | 'loading' | 'empty' | 'error' | 'success';
...
declare function Navbar({ theme, userName, status, onChangeProduct, onNotifications, onSettings, onSparkles, onProfile, onSignOut, }: NavbarProps): react_jsx_runtime.JSX.Element;
...
export { Button, type ButtonProps, type ButtonVariant, Card, CardActions, type CardActionsProps, CardBody, CardHeader, type CardHeaderProps, type CardProps, Icon, type IconProps, type IconSize, Navbar, type NavbarProps, type NavbarStatus, type NavbarTheme };
