...
function TitanTabs({
  ...
  return /* @__PURE__ */ jsxs7(Tabs, { className: overflow ? "tabs-root tabs-root-overflow" : "tabs-root", defaultSelectedKey, children: [
    /* @__PURE__ */ jsx8(
      TabList,
      {
        className: overflow ? "tabs-list tabs-list-scroll" : "tabs-list",
        "aria-label": ariaLabel,
        children: items.map((item) => /* @__PURE__ */ jsx8(Tab, { id: item.id, className: "tab-trigger", isDisabled: item.disabled, children: item.label }, item.id))
      }
    ),
